        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{$category_id==null ? route('category.create') : route('category.create',['category_id'=>$category_id]) }}"/>
                    <!--end::Add-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ $route_datatable }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    
                    <th>
                        {{ __('category::datatable.columns.photo') }}
                    </th>
                    ...
                    <th>
                        {{ __('category::datatable.columns.description') }}
                    </th>
