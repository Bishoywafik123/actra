...
class NewsDatatableController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        return DataTables::of($model)
            ...
            ->addColumn('content', function ($row) {
                return strip_tags(Str::limit($row->content,50));
             })
