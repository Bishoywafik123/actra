...
<form class="form fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="dt_modal_form"
    ...
    <div class="modal-header custom-modal-header" id="kt_modal_add_customer_header">
        ...
        <div class="d-flex flex-shrink-0 p-1">
            <p class="main-modal-title"><span class="svg-icon svg-icon-2 me-2"><i class="far fa-plus-circle fs-2"></span></i><span class="text-uppercase fs-3">{{ __('project::modal.add-title') }}</span></p>
        </div>
        <!--end::Modal title-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control custom-form-control"  style="direction: rtl" placeholder="" name="title_ar" value="">
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                    </div>
                        ...
                        <div class="option row">
                            ...
                            @foreach($languages as $suffix => $language)
                                <div class="col-md-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="control-label fs-6 mb-2">Name ({{ $language }})</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="name_{{ $suffix }}[]" class="form-control">
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="control-label fs-6 mb-2">Color ({{ $language }})</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="color_{{ $suffix }}[]" class="form-control">
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="control-label fs-6 mb-2">Description ({{ $language }})</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea style="height: 150px;" name="option_description_{{ $suffix }}[]" class="form-control"></textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
   ...
   removedfile: function(file) 
   {
       ...
       $.ajax({
           ...
           success: function (data){
              ...
              $('#kt_dropzone_1').find('input[name="main_photo"][value="'+name+'"]').remove();
           },
           error: function(e) {
               console.log(e);
           }
