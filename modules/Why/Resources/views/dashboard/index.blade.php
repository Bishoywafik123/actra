...
@section('pageHead')
<title>{{ __('why::header.title') }} | Sengine</title>
...
<div data-kt-swapper="true" data-kt-swapper-mode="prepend"
    ...
    <!--begin::Title-->
    <h1 class="d-flex align-items-center fw-bolder fs-3 my-1 toolbar-main-title-color">{{ __('why::header.title') }}</h1>
    <!--end::Title-->
</div>
<!--end::Page title-->
@endsection
        ...
        <div class="card">
            ...
            <div id="header-container" class="card-header border-0 pt-6">
                ...
                <x-dashboard::dt-toolbar>
                    ...
                    <!--begin::Add-->
                    <x-dashboard::dt-add-btn dt-target="_datatable" data-action-url="{{ route('why.create') }}"/>
                    <!--end::Add-->
                    ...
                    <x-slot name="group">
                        ...
                        <x-dashboard::dt-actn-grp>
                            <x-dashboard::dt-actn-grp-delete data-action-url="{{ route('why.destroy.many') }}" />
                        </x-dashboard::dt-actn-grp>
                        <!--end::Input group-->
                        <!--begin::Input group-->
            ...
            <div class="card-body pt-0">
                <!--begin::Table-->
                <x-dashboard::data-table id="_datatable" data-url="{{ route('why.datatable') }}" 
                    data-order='[[ 1, "desc" ]]' data-page-length='25'>

                    <th>
                        {{ __('why::datatable.columns.photo') }}
                    </th>

                    <th>
                        {{ __('why::datatable.columns.name') }}
                    </th>
                    <th>
                        {{ __('why::datatable.columns.description') }}
                    </th>

                    <th>
                        {{ __('why::datatable.columns.creation_date') }}
                    </th>
...
<script src="{{asset('/themes/metro8/assets/modules/why/js/why.js')}}"></script>
